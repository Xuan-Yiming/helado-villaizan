...
import { inter } from '../../ui/fonts';  // Importando la fuente desde fonts.ts
...
export default function PublicarPage() {
  ...
  const [users] = useState([
    { id: 1, name: 'Facebook - Heladería Villaizan' },
    { id: 2, name: 'Instagram - @villaizanpaletasartesanales' },
    { id: 3, name: 'TikTok - @heladeriavillaizan' },
  ]);
  ...
  return (
    <div className={`${inter.className} flex justify-center p-8`}>
      <div className="w-full max-w-7xl bg-white rounded-lg shadow-lg p-8 flex flex-col space-y-4">
        <div className="flex space-x-8">
          ...
          {/* Bloque derecho - Vista previa */}
          <div className="w-1/3 p-4 border rounded bg-gray-50">
            <h3 className="font-semibold mb-2 text-black">Vista previa de la publicación:</h3>
            <p className="text-black">{postText || 'Escribe algo para ver la vista previa...'}</p>
            {media && <img src={media} alt="Media" className="mt-4 w-full h-64 object-cover" />}
          </div>
        </div>

        {/* Botones de guardar y publicar alineados a la derecha */}
