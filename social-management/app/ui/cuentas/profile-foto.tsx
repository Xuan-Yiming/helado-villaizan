...
const ProfilePhotoUpload: React.FC<ProfilePhotoUploadProps> = ({
  ...
  const handleProfileUpdate = async () => {
    ...
    try {
      ...
      showError("No se puede guardar la foto de perfil: "+error);
    } finally {
  ...
  return (
    <div className="mb-4">
      <label className="block font-bold text-xl mb-4">Foto de perfil</label>
      <input
        type="file"
        accept="image/*"
      ...
      <div className="mb-4 flex flex-col items-center">
        ...
        <div className="flex flex-row">
          ...
          <button
            ...
            className="mt-2 mr-4 px-4 py-2 bg-blue-500 text-white rounded-md shadow-sm flex items-center justify-center"
          >
